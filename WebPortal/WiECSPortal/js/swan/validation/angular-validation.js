    ...
    angular.module('validation.provider', [])
        .provider('$validation', function() {
            ...
            this.getSuccessHTML = function(message) {
                return '<span class="validation-valid">' + message + '</span>';
            };
...
(function() {
    angular.module('validation.directive', ['validation.provider', 'pascalprecht.translate'])
        .directive('validator', ['$injector', '$translate',
            function($injector, $translate) {
                ...
                var invalidFunc = function(element, validMessage, validation, scope, ctrl) {
                    ...
                    if ($validationProvider.showErrorMessage && messageToShow) {
                    	$translate(messageToShow).then(function(translation){
                    		messageElem.html($validationProvider.getErrorHTML(translation));
                    	}, function(){ 
