 ...
 *
 */
.factory('$translateLocalStorage', $translateLocalStorage);

function $translateLocalStorage($window, $translateCookieStorage) {
...
$translateLocalStorage.$inject = ['$window', '$translateCookieStorage'];
$translateLocalStorage.displayName = '$translateLocalStorage';
